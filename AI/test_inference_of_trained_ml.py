...
import numpy as np
# Load the test data
X_test = pd.read_csv("/home/ramanujan/git_repos/BMS-DNN/BMS/dataset/test/test_features.csv")
y_test = pd.read_csv("/home/ramanujan/git_repos/BMS-DNN/BMS/dataset/test/test_labels.csv")
...
# Load the saved model
model = load_model("/home/ramanujan/git_repos/BMS-DNN/BMS/BMS_DNN/model/dnn_model.keras")
