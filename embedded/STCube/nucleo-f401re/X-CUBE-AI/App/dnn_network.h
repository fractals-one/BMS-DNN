/**
  ...
  ******************************************************************************
  */
#ifndef AI_DNN_NETWORK_H
#define AI_DNN_NETWORK_H

#include "dnn_network_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_DNN_NETWORK_MODEL_NAME          "dnn_network"
#define AI_DNN_NETWORK_ORIGIN_MODEL_NAME   "dnn_model"

/******************************************************************************/
#define AI_DNN_NETWORK_ACTIVATIONS_ALIGNMENT   (4)
#define AI_DNN_NETWORK_INPUTS_IN_ACTIVATIONS   (4)
#define AI_DNN_NETWORK_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_DNN_NETWORK_IN_NUM        (1)

AI_DEPRECATED
#define AI_DNN_NETWORK_IN \
  ai_dnn_network_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_DNN_NETWORK_IN_SIZE { \
  AI_DNN_NETWORK_IN_1_SIZE, \
}
#define AI_DNN_NETWORK_IN_SIZE_BYTES { \
  AI_DNN_NETWORK_IN_1_SIZE_BYTES, \
}
#define AI_DNN_NETWORK_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_DNN_NETWORK_IN_1_CHANNEL     (6)
#define AI_DNN_NETWORK_IN_1_SIZE        (6)
#define AI_DNN_NETWORK_IN_1_SIZE_BYTES  (24)

/******************************************************************************/
#define AI_DNN_NETWORK_OUT_NUM       (1)

AI_DEPRECATED
#define AI_DNN_NETWORK_OUT \
  ai_dnn_network_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_DNN_NETWORK_OUT_SIZE { \
  AI_DNN_NETWORK_OUT_1_SIZE, \
}
#define AI_DNN_NETWORK_OUT_SIZE_BYTES { \
  AI_DNN_NETWORK_OUT_1_SIZE_BYTES, \
}
#define AI_DNN_NETWORK_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_DNN_NETWORK_OUT_1_CHANNEL     (1)
#define AI_DNN_NETWORK_OUT_1_SIZE        (1)
#define AI_DNN_NETWORK_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_DNN_NETWORK_N_NODES (12)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup dnn_network
 ...
 * @ref ai_dnn_network_create. Both the activations memory buffer 
 ...
 * using @ref ai_dnn_network_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_dnn_network_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_dnn_network_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_DNN_NETWORK_*
 * defines into file @ref dnn_network.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_dnn_network_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_DNN_NETWORK_H */
